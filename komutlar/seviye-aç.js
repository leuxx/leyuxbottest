...
exports.run = async(client, message, args) => { 
    ...
    if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:x_:711295776055361617> Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.`);
  ...
  let knd = new Discord.RichEmbed()
  .setTitle(' <a:tik:711295763073728612> | Aktif Edildi!')
