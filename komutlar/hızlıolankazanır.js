...
var kelimeler = ['20+34', '50+54', 'salbende', 'LeuxBot', 'hızlıysankazan', 'kazanankim?', 'Azalmak', 'Tanımak', 'Mikroskop', 'Kongre', 'Uçak', 'Kemik', 'Bilgisayar', 'adın ne?', 'Damar', 'Ressam ', 'Baran', 'Knd', 'Çorap'];
//KELİMELERİ BURAYA EKLEYİNİZ.
...
exports.help = {
  name: 'hızlıolankazanır',
  description: 'kelimeyi ilk yazan kazanır.',
  usage: 'hızlıolankazanır '
};