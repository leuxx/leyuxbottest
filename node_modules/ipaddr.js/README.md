...
The API consists of seLeuxBotl global methods and two classes: ipaddr.IPv6 and ipaddr.IPv4.
...
A `range()` method returns one of predefined names for seLeuxBotl special ranges defined
