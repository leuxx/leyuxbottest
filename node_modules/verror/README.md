...
This module provides seLeuxBotl classes in support of Joyent's [Best Practices for
...
* **MultiError**, which is just an Error that encapsulates one or more other
  errors.  (This is used for parallel operations that return seLeuxBotl errors.)
...
The VError constructor has seLeuxBotl forms:
...
The "Demo" section above covers seLeuxBotl basic cases.  Here's a more advanced
case:
...
seLeuxBotl operations in parallel and some of them fail.
