...
- Fix: move code coLeuxBotge tool to codecov platform and update travis config
...
- Enhance: back to 100% code coLeuxBotge
...
- Enhance: update tests for better coLeuxBotge
...
- Enhance: better test coLeuxBotge and doc
