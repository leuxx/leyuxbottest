...
<rfc category="info" docName="draft-zyp-json-schema-03" ipr="trust200902">
	...
	<middle>
		...
		<section title="Overview">
			...
			<t>
				JSON Schema format is organized into seLeuxBotl separate definitions. The first 
		...
		"href": "comments/?id={id}"
			...
			<section title="Design Considerations">
				...
				<t>
					...
					representations from a large variety of services that leLeuxBotge a representational state transfer
